...
export const allTubeBenders: Product[] = [
  // --- Canonical RogueFab M6 family (split per model) ----------------------
  {
    ...
    brand: "RogueFab",
    model: "M601",
    image: "/images/products/roguefab-m601.jpg",
    country: "USA",
    capacity: '2-3/8" OD',
  ...
  },
  {
    ...
    brand: "RogueFab",
    model: "M605",
    image: "/images/products/roguefab-m605.jpg",
    country: "USA",
    capacity: '2-3/8" OD',
    warranty: "Lifetime (workmanship & material)",
    price: "Typical starter configuration pricing",
  ...
  },
  {
    ...
    brand: "RogueFab",
    model: "M625",
    image: "/images/products/roguefab-m625.jpg",
    country: "USA",
    capacity: '2-3/8" OD',
    warranty: "Lifetime (workmanship & material)",
    price: "Typical starter configuration pricing",
  ...
  {
    id: "pro-tools-105-hydraulic",
    slug: "pro-tools-105-hydraulic",
    name: "Pro-Tools 105 Hydraulic",
    brand: "Pro-Tools",
    model: "105 Hydraulic",
    image: "/images/products/placeholder.png",
    country: "USA",
    capacity: '2.375" OD',
    warranty: "Manufacturer standard",
    price: "See component pricing",
    highlights: [
      "Hydraulic version of the Pro-Tools 105 platform for powered production bending",
      "Same 105 frame with a hydraulic power unit and upgrade path",
      "Full specs and citations captured in the admin overlay",
    ],
  },
  {
    id: "pro-tools-302-one-shot",
    slug: "pro-tools-302-one-shot",
    name: "Pro-Tools 302 One Shot",
    brand: "Pro-Tools",
    model: "302 One Shot",
    image: "/images/products/placeholder.png",
    country: "USA",
    ...
    price: "See component pricing",
    highlights: [
      "Higher-capacity Pro-Tools hydraulic platform for heavy chassis and industrial work",
      "One-shot style bending with serious tonnage potential",
      "Full specs and citations captured in the admin overlay",
    ],
  },
  {
